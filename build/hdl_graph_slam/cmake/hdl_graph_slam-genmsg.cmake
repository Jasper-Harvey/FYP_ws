...
message(STATUS "hdl_graph_slam: 2 messages, 2 services")

set(MSG_I_FLAGS "-Ihdl_graph_slam:/home/jasper/FYP_ws/src/hdl_graph_slam/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jasper/FYP_ws/src/hdl_graph_slam/srv/DumpGraph.srv" NAME_WE)
add_custom_target(_hdl_graph_slam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hdl_graph_slam" "/home/jasper/FYP_ws/src/hdl_graph_slam/srv/DumpGraph.srv" ""
)

get_filename_component(_filename "/home/jasper/FYP_ws/src/hdl_graph_slam/srv/SaveMap.srv" NAME_WE)
add_custom_target(_hdl_graph_slam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hdl_graph_slam" "/home/jasper/FYP_ws/src/hdl_graph_slam/srv/SaveMap.srv" ""
)

get_filename_component(_filename "/home/jasper/FYP_ws/src/hdl_graph_slam/msg/FloorCoeffs.msg" NAME_WE)
add_custom_target(_hdl_graph_slam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hdl_graph_slam" "/home/jasper/FYP_ws/src/hdl_graph_slam/msg/FloorCoeffs.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/jasper/FYP_ws/src/hdl_graph_slam/msg/ScanMatchingStatus.msg" NAME_WE)
add_custom_target(_hdl_graph_slam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hdl_graph_slam" "/home/jasper/FYP_ws/src/hdl_graph_slam/msg/ScanMatchingStatus.msg" "std_msgs/String:geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:std_msgs/Header"
)
...
_generate_msg_cpp(hdl_graph_slam
  ...
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/std_msgs/cmake/../msg/String.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Pose.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Point.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Quaternion.msg;/opt/ros/melodic/share/std_msgs/cmake/../msg/Header.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/hdl_graph_slam
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hdl_graph_slam)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hdl_graph_slam\")")
  # install generated code
  install(
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hdl_graph_slam/.+/__init__.pyc?$"
  )
endif()
