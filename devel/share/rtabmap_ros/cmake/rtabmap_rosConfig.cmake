...
if("TRUE" STREQUAL "TRUE")
  set(rtabmap_ros_SOURCE_PREFIX /home/jasper/FYP_ws/src/rtabmap_ros)
  set(rtabmap_ros_DEVEL_PREFIX /home/jasper/FYP_ws/devel)
  ...
  set(rtabmap_ros_INSTALL_PREFIX /home/jasper/FYP_ws/install)
...
if(NOT "/home/jasper/FYP_ws/devel/include;/home/jasper/FYP_ws/src/rtabmap_ros/include;/home/jasper/FYP_ws/devel/lib/rtabmap-0.20/../../include/rtabmap-0.20;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(rtabmap_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/jasper/FYP_ws/devel/include;/home/jasper/FYP_ws/src/rtabmap_ros/include;/home/jasper/FYP_ws/devel/lib/rtabmap-0.20/../../include/rtabmap-0.20;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtabmap_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jasper/FYP_ws/src/rtabmap_ros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rtabmap_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rtabmap_ros;/home/jasper/FYP_ws/devel/lib/librtabmap_core.so;/home/jasper/FYP_ws/devel/lib/librtabmap_utilite.so;/home/jasper/FYP_ws/devel/lib/librtabmap_gui.so;/usr/lib/x86_64-linux-gnu/libz.so;/opt/ros/melodic/lib/libg2o_core.so;/opt/ros/melodic/lib/libg2o_types_slam2d.so;/opt/ros/melodic/lib/libg2o_types_slam3d.so;/opt/ros/melodic/lib/libg2o_types_sba.so;/opt/ros/melodic/lib/libg2o_stuff.so;/opt/ros/melodic/lib/libg2o_solver_csparse.so;/opt/ros/melodic/lib/libg2o_csparse_extension.so;/usr/lib/x86_64-linux-gnu/libcxsparse.so;/opt/ros/melodic/lib/libg2o_solver_cholmod.so;/usr/lib/x86_64-linux-gnu/libcholmod.so;/usr/lib/x86_64-linux-gnu/libfreenect.so;/usr/lib/x86_64-linux-gnu/libfreenect_sync.so;/usr/lib/libOpenNI2.so;/usr/lib/x86_64-linux-gnu/libdc1394.so;/opt/ros/melodic/lib/liboctomap.so;/opt/ros/melodic/lib/liboctomath.so;/usr/local/lib/libopencv_core.so.3.2.0;/usr/local/lib/libopencv_calib3d.so.3.2.0;/usr/local/lib/libopencv_imgproc.so.3.2.0;/usr/local/lib/libopencv_highgui.so.3.2.0;/usr/local/lib/libopencv_stitching.so.3.2.0;/usr/local/lib/libopencv_optflow.so.3.2.0;/usr/local/lib/libopencv_photo.so.3.2.0;/usr/local/lib/libopencv_video.so.3.2.0;/usr/local/lib/libopencv_aruco.so.3.2.0;/usr/local/lib/libopencv_xfeatures2d.so.3.2.0")
