...
class RawUdpArray {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.packets.forEach((val) => {
      bufferOffset = RawUdp.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    object.packets.forEach((val) => {
      length += RawUdp.getMessageSize(val);
    });
    return length + 4;
  }
